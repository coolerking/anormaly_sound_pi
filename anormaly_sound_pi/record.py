...
parser.add_argument('--file', type=str, default='test.wav', help='record filename')
...
record_secs = 3 #args.sec # 録音する秒数(sec)
dev_index = 1 #args.dev_index # デバイス番号
wav_output_filename = 'test.wav' #args.file # 出力するファイル
